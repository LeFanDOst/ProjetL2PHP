...
(
	...
	CONSTRAINT FK_MatchPoule_EquipePoule2 FOREIGN KEY (idEquipe2) REFERENCES EquipePoule(idEquipe) ON UPDATE CASCADE ON DELETE CASCADE,
...
INSERT INTO Type VALUES (1, 5, 'Tournoi');
